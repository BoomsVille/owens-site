      ...
      {isGameOpen && (
        ...
        >
          <div className="flex min-h-full items-center justify-center p-3 sm:p-5">
            <div className="w-full max-w-5xl overflow-hidden rounded-2xl border border-slateLine/80 bg-[#071127]/95 shadow-[0_28px_90px_rgba(0,0,0,0.55)]">
              <div className="flex items-center justify-between border-b border-slateLine/70 bg-slatePanel/35 px-4 py-3">
                ...
                <button
                  ...
                  className="rounded-full border border-slateLine px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.13em] text-mistSoft transition-colors duration-200 hover:border-accentBlue hover:text-mist"
                >
                  Close
                </button>
              </div>
